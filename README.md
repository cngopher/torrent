 ...
 * [bencode](https://godoc.org/github.com/cngopher/torrent/bencode)
 * [tracker](https://godoc.org/github.com/cngopher/torrent/tracker)

## Installation

Install the library package with `go get github.com/cngopher/torrent`, or the provided cmds with `go get github.com/cngopher/torrent/cmd/...`.

## Library examples

There are some small [examples](https://godoc.org/github.com/cngopher/torrent#pkg-examples) in the package documentation.
...
Communication about the project is primarily through [Gitter](https://gitter.im/anacrolix/torrent) and the [issue tracker](https://github.com/cngopher/torrent/issues).
...
Downloads torrents from the command-line. This first example does not use `godo`.
	...
	$ go get github.com/cngopher/torrent/cmd/torrent
...
torrentfs mounts a FUSE filesystem at `-mountDir`. The contents are the torrents described by the torrent files and magnet links at `-metainfoDir`. Data for read requests is fetched only as required from the torrent network, and stored at `-downloadDir`.
    ...
    $ mkdir mnt torrents
    $ godo github.com/cngopher/torrent/cmd/torrentfs -mountDir=mnt -metainfoDir=torrents &
    $ cd torrents
...
Creates a magnet link from a torrent file. Note the extracted trackers, display name, and info hash.
    ...
    $ godo github.com/cngopher/torrent/cmd/torrent-magnet < ubuntu-14.04.2-desktop-amd64.iso.torrent
